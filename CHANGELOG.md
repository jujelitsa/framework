...
## [ [0.4.0](https://github.com/jujelitsa/framework/releases/tag/0.4.0) ] - 03.08.2026
...
- Изменено:
  ...
  - Добавлена возможность фильтровать данные через OR
- Исправлено:
  - Проверка существования записи при изменении
  - Порядок выполнения миделвееров
...
- Исправлено:
  - BuildQuery в DataBaseResourceWriter
